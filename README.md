...
1. В директории проекта в SmartApp Code выбрать "Настройки проекта"-> "Дополнительно". Активировать пункт "Отправлять команду /start на запуск голосом".
1. В директории проекта в SmartApp Code выбрать "Редактор"-> "Сущности". Далее перейти на вкладку "Системные", в выпадающем списке найти и активировать сущность "duckling.number"
